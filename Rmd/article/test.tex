...
\emph{ggplot2} (Version 3.1.0; Wickham, 2016), \emph{ggpubr} (Version
0.2; Kassambara, 2018), \emph{glue} (Version 1.3.0; Hester, 2018),
\emph{here} (Version 0.1; Müller, 2017), \emph{magrittr} (Version 1.5;
Bache \& Wickham, 2014), \emph{pander} (Version 0.6.3; Daróczi \&
Tsegelskyi, 2018), and \emph{papaja} (Version 0.1.0.9842; Aust \& Barth,
...
Kassambara, A. (2018). \emph{Ggpubr: 'Ggplot2' based publication ready
