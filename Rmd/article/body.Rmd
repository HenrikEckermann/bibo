...
Our second hypothesis would have predicted a significant three-way interaction between the time-points, CC and breastfeeding with follow up models showing that the effect of CC over time is significantly larger for non-breastfed infants. However, this hypothesis could not be tested due to the absence of an effect of CC.
