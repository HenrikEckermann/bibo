...
### **Alpha diversity, Beta diversity and relative abundances between groups and time points PRE/POST** {data-width=800}

```{r, eval = TRUE,fig.height=10, fig.width=15, dpi=300}
theme_set(theme_minimal(base_size = 18))
biplot_time_2 <- biplot(pseq.clr, facet = "cc", connect_series = "time")
biplot_time_2[[1]] + {(p_div[[1]] | differential_abundance_plots_article) + plot_layout(widths =  c(1, 3))} + plot_layout(ncol = 1, heights = c(1, 1))
...
### Results {data-width=45}

- Slight decrease in alpha diversity in the childcare attendance group (A).
- Small differences in relative abundances between the groups after controlling for age and breastfeeding (B). 
- There was no effect of childcare attendance on overall composition (C).
- High variation: Many infants showed an opposite trend compared to the group level effect.


### Conclusion {data-width=45}
- Childcare attendance did not lead to a uniform change in gut microbiota composition or disrupt early development of the microbial ecosystem.
